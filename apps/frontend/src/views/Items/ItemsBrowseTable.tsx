                  ...
                  <>
                    ...
                    >
                      ...
                      <TableCell padding="checkbox">
                        <Tooltip
                          title={
                            isFav(item.itemid) ? "Remove from favourites" : "Add to favourites"
                          }
                        >
                          <IconButton
                            size="small"
                        ...
                        <Tooltip
                          title={
                            isItemStale(item)
                              ...
                              : [
                                  item.lastvalue || "",
                                  item.lastclock ? `Last collected ${timeAgo(item.lastclock)}` : "",
                                ]
                                  .filter(Boolean)
                                  .join("\n\n")
                          }
                            ...
                            <Box sx={{ display: "flex", gap: 4, mt: 0.75, flexWrap: "wrap" }}>
                              <Box>
                                ...
                                <Typography variant="body2" sx={{ fontSize: "0.8rem" }}>
                                  {valueTypes.find((vt) => vt.value === Number(item.value_type))
