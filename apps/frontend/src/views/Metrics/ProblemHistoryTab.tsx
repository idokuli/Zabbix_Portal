          ...
          <Table size="small">
            <TableHead>
              <TableRow sx={{ bgcolor: isDark ? "rgba(255,255,255,0.025)" : "rgba(0,0,0,0.025)" }}>
                <TableCell sx={{ fontWeight: 700, fontSize: "0.72rem", width: 145 }}>
                  Started
                </TableCell>
                <TableCell sx={{ fontWeight: 700, fontSize: "0.72rem", width: 140 }}>
                  Host
                </TableCell>
                <TableCell sx={{ fontWeight: 700, fontSize: "0.72rem" }}>Problem</TableCell>
                <TableCell sx={{ fontWeight: 700, fontSize: "0.72rem", width: 90 }}>
                  Severity
                </TableCell>
                <TableCell sx={{ fontWeight: 700, fontSize: "0.72rem", width: 110 }}>
                  Status
                </TableCell>
                <TableCell sx={{ fontWeight: 700, fontSize: "0.72rem", width: 80 }}>
                  Duration
                </TableCell>
                ...
                filtered.map((p) => (
                  <TableRow key={p.eventid} sx={{ "&:hover": { bgcolor: "action.hover" } }}>
                    ...
                    <TableCell>
                      <Typography
                        noWrap
                        sx={{ fontSize: "0.82rem", fontWeight: 500, maxWidth: 130 }}
                      >
                        {p.hostname}
                      </Typography>
                    </TableCell>
                        ...
                        <Tooltip title={`Resolved ${formatAbsTime(p.r_clock)}`} placement="top">
                          <Chip
                            ...
                            sx={{
                              height: 18,
                              fontSize: "0.63rem",
                              bgcolor: isDark ? "rgba(22,163,74,0.18)" : "rgba(22,163,74,0.1)",
                              color: "#16a34a",
                              border: "none",
                              cursor: "default",
                            }}
